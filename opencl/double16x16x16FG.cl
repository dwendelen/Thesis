...
__kernel void Kernel(__global const double4* T,
    __global const double4* U1, __global const double4* U2, __global const double4* U3, const int R, __global double* sum, __global double4* F)
{   
    __local double l[64];
    ...
    double sum1 = sum4.x + sum4.y + sum4.z + sum4.w;
